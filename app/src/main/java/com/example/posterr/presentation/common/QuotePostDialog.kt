...
fun QuotePostDialog(
    ...
    AlertDialog(
        ...
        title = { Text(stringResource(id = R.string.quote_post_title)) },
        text = {
            Column {
                if (!canCreatePost) {
                    Text(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(id = R.string.label_add_comment)) },
        ...
        confirmButton = {
            Button(
                ...
                Text(stringResource(id = R.string.action_quote))
            }
        },
        dismissButton = {
